...
//
///**
// * This tests for variability in bullet power administered by the robot Hulk.
// *
// * @author Philip Johnson
// */
//public class TestHulkFiring extends RobotTestBed {
//
//    // True if Hulk has fired a bullet with power less than 1.4;
//    boolean firePowerReachLevelOne = false;
//    // True if Hulk has fired a bullet with power between 1.5 to 1.9;
//    boolean firePowerReachLevelTwo = false;
//    // True if Hulk has fired a bullet with power between 2.0 to 2.4;
//    boolean firePowerReachLevelThree = false;
//    // True if Hulk has fired a bullet with power greater than 2.4;
//    boolean firePowerReachLevelFour = false;
//
//    /**
//     * Specifies that SittingDuck and Hulk are to be matched up in this test case.
//     *
//     * @return The comma-delimited list of robots in this match.
//     */
//    @Override
//    public String getRobotNames() {
//        return "sample.Tracker,green.Hulk";
//    }
//
//    /**
...
//     * that Hulk is using proportional firing based on distance of detected enemy robot.
//     *
...
//
//        // All active bullets belong to Hulk since SittingDuck does not fire.
...
//
//    /**
//     * After running all matches, determine if Hulk has had variability in its bullet power.
//     *
