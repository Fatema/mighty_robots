...
Install both the robocode basic distribution and the robocode testing plugin.  Both of these setup.jar files are available for version 1.9.3.2 [here](https://sourceforge.net/projects/robocode/files/robocode/1.9.3.2/). 
...
Be sure to run mvn --version to verify that it is correctly installed.  This package has been tested using Maven 3.3.9.

3. Download this robocode-green-hulk package
----------------------------------------------
...
```
mvn install:install-file -Dfile=robocode.jar -DartifactId=robocode  -DgroupId=net.sourceforge.robocode -Dversion=1.9.3.2 -Dpackaging=jar -DgeneratePom=true
mvn install:install-file -Dfile=robocode.testing.jar -DartifactId=robocode.testing -DgroupId=net.sourceforge.robocode  -Dversion=1.9.3.2 -Dpackaging=jar -DgeneratePom=true
mvn install:install-file -Dfile=robocode.battle-1.9.3.2.jar -DartifactId=robocode.battle -DgroupId=net.sourceforge.robocode -Dversion=1.9.3.2 -Dpackaging=jar -DgeneratePom=true
mvn install:install-file -Dfile=robocode.core-1.9.3.2.jar   -DartifactId=robocode.core   -DgroupId=net.sourceforge.robocode -Dversion=1.9.3.2 -Dpackaging=jar -DgeneratePom=true
mvn install:install-file -Dfile=robocode.host-1.9.3.2.jar   -DartifactId=robocode.host   -DgroupId=net.sourceforge.robocode -Dversion=1.9.3.2 -Dpackaging=jar -DgeneratePom=true
mvn install:install-file -Dfile=robocode.repository-1.9.3.2.jar -DartifactId=robocode.repository   -DgroupId=net.sourceforge.robocode -Dversion=1.9.3.2 -Dpackaging=jar -DgeneratePom=true
...
```
[~/robocode/libs]-> mvn install:install-file -Dfile=robocode.jar -DartifactId=robocode -DgroupId=net.sourceforge.robocode -Dversion=1.9.3.2 -Dpackaging=jar -DgeneratePom=true
...
[INFO] Installing /Users/johnson/robocode/libs/robocode.jar to /Users/johnson/.m2/repository/net/sourceforge/robocode/robocode/1.9.3.2/robocode-1.9.3.2.jar
[INFO] Installing /var/folders/__/qq1ydtj56n3fxtccjh9k6dk80000gn/T/mvninstall1027288217865601684.pom to /Users/johnson/.m2/repository/net/sourceforge/robocode/robocode/1.9.3.2/robocode-1.9.3.2.pom
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
...
```shell
[~/projecthosting/github/robocode-green-hulk]-> mvn -Drobocode.home=/Users/johnson/robocode test
[INFO] Scanning for projects...
[INFO]                                                                         
[INFO] ------------------------------------------------------------------------
[INFO] Building hulk 1.0-SNAPSHOT
[INFO] ------------------------------------------------------------------------
[INFO] 
[INFO] --- maven-resources-plugin:2.6:resources (default-resources) @ hulk ---
[INFO] Using 'UTF-8' encoding to copy filtered resources.
[INFO] skip non existing resourceDirectory /Users/johnson/projecthosting/github/robocode-green-hulk/src/main/resources
[INFO] 
[INFO] --- maven-compiler-plugin:2.3.2:compile (default-compile) @ hulk ---
[INFO] Compiling 1 source file to /Users/johnson/projecthosting/github/robocode-green-hulk/target/classes
[INFO] 
[INFO] --- maven-resources-plugin:2.6:copy-resources (copy-resources) @ hulk ---
[INFO] Using 'UTF-8' encoding to copy filtered resources.
[INFO] Copying 1 resource
[INFO] 
[INFO] --- maven-resources-plugin:2.6:testResources (default-testResources) @ hulk ---
[INFO] Using 'UTF-8' encoding to copy filtered resources.
[INFO] skip non existing resourceDirectory /Users/johnson/projecthosting/github/robocode-green-hulk/src/test/resources
[INFO] 
[INFO] --- maven-compiler-plugin:2.3.2:testCompile (default-testCompile) @ hulk ---
[INFO] Compiling 3 source files to /Users/johnson/projecthosting/github/robocode-green-hulk/target/test-classes
[INFO] 
[INFO] --- maven-surefire-plugin:2.10:test (default-test) @ hulk ---
[INFO] Surefire report directory: /Users/johnson/projecthosting/github/robocode-green-hulk/target/surefire-reports

-------------------------------------------------------
 T E S T S
-------------------------------------------------------
Running green.TestHulkFiring
...
Running green.TestHulkMovement
Preparing battle...
----------------------
Round 1 initializing..
Let the games begin!
...
Running green.TesthulkVersusSittingDuck
Preparing battle...
----------------------
Round 1 initializing..
Let the games begin!
...
```shell
[~/projecthosting/github/robocode-green-hulk]-> mvn -Drobocode.home=/Users/johnson/robocode clean
[INFO] Scanning for projects...
[INFO]                                                                         
[INFO] ------------------------------------------------------------------------
[INFO] Building hulk 1.0-SNAPSHOT
[INFO] ------------------------------------------------------------------------
[INFO] 
[INFO] --- maven-clean-plugin:2.5:clean (default-clean) @ hulk ---
[INFO] Deleting /Users/johnson/projecthosting/github/robocode-green-hulk/target
[INFO] Deleting /Users/johnson/robocode/robots/green (includes = [], excludes = [])
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
...
[INFO] ------------------------------------------------------------------------
```
6.  Install robocode-green-hulk into Eclipse
----------------------------------------------
...
To run the green.hulk robot within Eclipse, you must configure Eclipse and Robocode in the normal way:
...
Once you have completed the above steps, you are ready to use this project for your own development. To do this:
  * Duplicate the robocode-green-hulk directory, and rename it with your own robot's name.
  ...
  * In Eclipse, select the project (robocode-green-hulk), then right-click and Refactor | Rename to rename the project to your own robot name.
